...
async function annotateDocument(text) {
    const systemPrompt = `Ти — експерт з аналізу документів. Твоя єдина задача — надати дуже коротке резюме документа, відповідаючи на питання "Про що цей документ?". Відповідь повинна бути лише одним, коротким реченням, без додаткової інформації, заголовків чи списків. Не повертай оригінальний документ. Надай тільки резюме.`;
